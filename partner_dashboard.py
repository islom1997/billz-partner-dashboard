        ...
        if not my_clients_df.empty:
            ...
            def calc_bonus(row):
                ...
                if pd.notna(created) and created < cutoff_date:
                    return 0  # Older than 12 months relative to selected month
            ...
            # Calculate Portfolio Income (Портфельный доход)
            # Based on total number of active clients in the selected month
